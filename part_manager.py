...
part_text = StringVar()
part_label = Label(app, text='Part Name', font=('bold',14), pady=20, padx=5)
...
retailer_label = Label(app, text='Retailer Name', font=('bold',14), pady=20, padx=5)
...
add_btn = Button(app, text='Add Part', width=12, command=add_itm)
add_btn.grid(row=2,column=0, pady=20)

remove_btn = Button(app, text='Remove Part', width=12, command=remove_itm)
remove_btn.grid(row=2,column=1)

update_btn = Button(app, text='Update Part', width=12, command=update_itm)
